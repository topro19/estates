...
class App {
  ...
  addEventListeners() {
    ...
    // Bind interactions to the container instead of window to prevent page scroll fights
    this.container.addEventListener('mousewheel', this.boundOnWheel, { passive: true });
    this.container.addEventListener('wheel', this.boundOnWheel, { passive: true });
    this.container.addEventListener('mousedown', this.boundOnTouchDown);
    this.container.addEventListener('touchstart', this.boundOnTouchDown, { passive: true });
    
    // Window interactions are active for tracking release and move once click starts
...
export default function CircularGallery({
  ...
  useEffect(() => {
    ...
    resolveFont(font, fontUrl).then(resolvedFont => {
      ...
      // Lazy render: Pause rendering loop when off-screen to optimize CPU/GPU cycles
